...
public class ListSlavesActivity extends ListActivity implements LoaderManager.LoaderCallbacks<Cursor> {

    static String[] prenoms = new String[]{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView liste = (ListView) findViewById(R.id.slaves_list);
